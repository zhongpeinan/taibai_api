...
mod tests {
    ...
    fn test_unhealthy_pod_eviction_policy_type_serialize() {
        ...
        assert_eq!(json, "\"IfHealthyBudget\"");
    }
    ...
    fn test_pod_disruption_budget_status_default() {
        ...
        assert_eq!(status.desired_healthy, 0);
    ...
    fn test_pod_disruption_budget_serialize() {
        ...
        assert!(json.contains("\"name\":\"my-pdb\""));
        assert!(json.contains("\"minAvailable\""));
    }
    ...
    fn test_eviction_with_metadata() {
        ...
        assert_eq!(eviction.metadata.name, Some("my-pod".to_string()));
    }

    #[test]
    fn test_pod_disruption_budget_list_empty() {
