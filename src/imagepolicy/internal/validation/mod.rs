//! Validation for Kubernetes ImagePolicy internal API types
//!
//! Upstream does not define validation; this is a no-op to match behavior.

use crate::common::validation::{ErrorList, Path};
use crate::imagepolicy::internal::{ImageReview, ImageReviewList};
