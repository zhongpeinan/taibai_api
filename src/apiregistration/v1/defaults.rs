//! Default values for apiregistration v1 API types
//!
//! Ported from k8s.io/kube-aggregator/pkg/apis/apiregistration/v1/defaults.go
...
impl ApplyDefault for APIService {
    fn apply_default(&mut self) {
        if self.type_meta.api_version.is_empty() {
            self.type_meta.api_version = "apiregistration.k8s.io/v1".to_string();
        }
