...
impl crate::common::traits::ResourceSchema for IPAddress {
    ...
    fn kind(_meta: &Self::Meta) -> &str { "IPAddress" }
    fn resource(_meta: &Self::Meta) -> &str { "ipaddresses" }
    fn group_static() -> &'static str { "networking.k8s.io" }
    fn version_static() -> &'static str { "v1alpha1" }
    fn kind_static() -> &'static str { "IPAddress" }
    fn resource_static() -> &'static str { "ipaddresses" }
}
