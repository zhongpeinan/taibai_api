//! Default values for certificates v1beta1 API types
//!
//! Ported from k8s/pkg/apis/certificates/v1beta1/zz_generated.defaults.go

use crate::common::ApplyDefault;

use super::{
    CertificateSigningRequest, CertificateSigningRequestList, ClusterTrustBundle,
...
impl ApplyDefault for CertificateSigningRequest {
    fn apply_default(&mut self) {
        if self.type_meta.api_version.is_empty() {
            self.type_meta.api_version = "certificates.k8s.io/v1beta1".to_string();
        }
...
mod tests {
    ...
    fn test_csr_apply_default_sets_type_meta() {
        ...
        assert_eq!(csr.type_meta.api_version, "certificates.k8s.io/v1beta1");
