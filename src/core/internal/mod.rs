...
pub use volume::{
    ...
    HostPathVolumeSource, ISCSIVolumeSource, ImageVolumeSource, KeyToPath, LocalVolumeSource,
    NFSVolumeSource, PersistentVolumeClaimTemplate, PersistentVolumeClaimVolumeSource,
