...
mod tests {
    ...
    #[test]
    fn test_pod_phase_deserialize() {
        assert_eq!(
            serde_json::from_str::<PodPhase>(r#""Running""#).unwrap(),
            PodPhase::Running
        );
    }

    #[test]
    fn test_pod_phase_constants() {
    ...
    // RestartPolicy tests
    #[test]
    fn test_restart_policy_serialize() {
        assert_eq!(
    ...
    // DNSPolicy tests
    #[test]
    fn test_dns_policy_serialize() {
        assert_eq!(
            serde_json::to_string(&DNSPolicy::ClusterFirst).unwrap(),
            r#""ClusterFirst""#
        );
    }

    #[test]
    fn test_dns_policy_deserialize() {
        assert_eq!(
            serde_json::from_str::<DNSPolicy>(r#""ClusterFirst""#).unwrap(),
    ...
    fn test_service_type_deserialize() {
        assert_eq!(
            serde_json::from_str::<ServiceType>(r#""ClusterIP""#).unwrap(),
    ...
    fn test_condition_status_deserialize() {
        assert_eq!(
            serde_json::from_str::<ConditionStatus>(r#""True""#).unwrap(),
