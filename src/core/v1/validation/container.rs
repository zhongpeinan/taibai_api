...
use crate::core::v1::validation::env::{validate_env, validate_env_from};
use crate::core::v1::validation::helpers::validate_container_name;
use crate::core::v1::validation::probe::{
...
pub fn validate_container_common(
    ...
    // if let Some(ref sec_ctx) = container.security_context {
    //     all_errs.extend(validate_security_context(sec_ctx, &path.child("securityContext")));
    // }
...
mod tests {
    ...
    fn test_validate_containers_duplicate_names() {
        let containers = vec![
            ...
            Container {
                name: "nginx".to_string(), // Duplicate name
    ...
    fn test_validate_init_containers_duplicate_with_regular() {
        ...
        let init_container = Container {
            name: "nginx".to_string(), // Same name as regular container
            image: Some("busybox:latest".to_string()),
            termination_message_policy: Some("File".to_string()),
            ..Default::default()
        };
