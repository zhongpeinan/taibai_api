//! Kubernetes API Discovery v2beta1 API types
//!
//! This module contains types from the Kubernetes apidiscovery/v2beta1 API group.
//!
//! **Deprecated**: This API is deprecated as of Kubernetes 1.32 and will be removed in 1.35.
//! Use `v2` instead.
//!
//! Source: https://github.com/kubernetes/api/blob/master/apidiscovery/v2beta1/types.go
...
///
/// **Deprecated**: This type is deprecated as of Kubernetes 1.32.
///
/// Source: https://github.com/kubernetes/api/blob/master/apidiscovery/v2beta1/types.go#L33
...
/// **Deprecated**: This type is deprecated as of Kubernetes 1.32.
///
/// Source: https://github.com/kubernetes/api/blob/master/apidiscovery/v2beta1/types.go#L52
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, Eq, Default)]
#[serde(rename_all = "camelCase")]
...
///
/// Source: https://github.com/kubernetes/api/blob/master/apidiscovery/v2beta1/types.go#L69
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, Eq, Default)]
#[serde(rename_all = "camelCase")]
...
///
/// Source: https://github.com/kubernetes/api/blob/master/apidiscovery/v2beta1/types.go#L87
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, Eq, Default)]
#[serde(rename_all = "camelCase")]
...
///
/// Source: https://github.com/kubernetes/api/blob/master/apidiscovery/v2beta1/types.go#L139
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, Eq, Default)]
#[serde(rename_all = "camelCase")]
...
impl ApplyDefault for APIGroupDiscovery {
    fn apply_default(&mut self) {
        if self.type_meta.api_version.is_empty() {
            self.type_meta.api_version = "apidiscovery.k8s.io/v2beta1".to_string();
        }
...
mod tests {
    ...
    fn test_apply_default_api_group_discovery() {
        ...
        assert_eq!(obj.type_meta.api_version, "apidiscovery.k8s.io/v2beta1");
